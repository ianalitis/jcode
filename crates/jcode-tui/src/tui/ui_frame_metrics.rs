...
#[path = "ui_frame_metrics/state.rs"]
mod state;
use state::{flicker_frame_history, frame_perf_stats, slow_frame_history};
...
#[cfg(test)]
mod draw_call_tests {
    include!("ui_frame_metrics_draw_call_tests_body_tests.rs");
}
