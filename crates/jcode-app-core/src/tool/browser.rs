...
fn status_metadata(
    ...
    json!({
        ...
        // Firefox automation always targets this dedicated profile, never a
        // personal one.
...
async fn ensure_firefox_ready(
    ...
    if !status.binary_installed {
        ...
        if target.kind.family() == crate::browser_detect::BrowserFamily::Gecko {
