...
pub struct TaskGraphNodeSpec {
    ...
    pub priority: u8,
    /// Declared route-table task class. Absence does not opt into admission.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub task_class: Option<String>,
    /// Declared provenance, not authorization. Admission treats absence as private.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub enum Request {
    ...
    CommSpawn {
        ...
        /// Maximum aggregate metered exposure this spawned worker may reserve
        /// across provider attempts. Metered spawns without this field are refused.
        #[serde(default, skip_serializing_if = "Option::is_none")]
        max_micro_usd: Option<u64>,
        /// Whole-child wall-clock execution deadline.
        #[serde(default, skip_serializing_if = "Option::is_none")]
        deadline_secs: Option<u64>,
        /// Provenance class for the spawned packet. Omitted defaults private at
        /// admission, which is ineligible for metered remote routes.
        #[serde(default, skip_serializing_if = "Option::is_none")]
        data_class: Option<jcode_attempt_types::DataClass>,
        /// Dynamic-router exclusions and cost tier frozen for this worker.
        #[serde(default, skip_serializing_if = "Option::is_none")]
