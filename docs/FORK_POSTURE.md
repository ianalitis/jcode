...
| two TUI account tests assert labels `upsert_account` never assigns | [#1367](https://github.com/1jehuang/jcode/issues/1367) | [#1368](https://github.com/1jehuang/jcode/pull/1368) | the store assigns `prefix-<animal>` and ignores the requested label; tests now use the returned label (19 -> 15 failures with #1366's 2) |
