...
| `2026-09-20-swarm-stop-queued-worker.md` | [#1352](https://github.com/1jehuang/jcode/issues/1352) | not yet; portable patch staged at [`patches-1352-swarm-stop.patch`](upstream-feedback/patches-1352-swarm-stop.patch) | stop acknowledges before owned work is cancelled; revalidated live upstream 2026-09-21 (green with patch, 0/4 negative control without) |
